...
$demo_link          = admin_url( 'themes.php?page=sq-panell#demo-data' );
...
$sections[] = array(
	...
	'fields'     => array(
		...
		array(
			...
			'subtitle' => esc_html__( 'Upload retina logo. This is optional and should be double in size than normal logo.', 'kleo' ),
		),
        array(
			'id'       => 'mobile_logo',
			'type'     => 'media',
...
$sections[] = array(
	...
	'fields'          => array(
		...
		array(
			...
			'subtitle' => esc_html__( 'Font size in pixels. Default: 12', 'kleo' ),
			'default'  => ''
		),
	),
	'customizer'      => false,
...
$sections[] = array(
	...
	'fields'     => array(
        ...
        array(
            ...
            'subtitle' => "Your WhatsApp group/number",
            'desc'     => 'For click to open WhatsApp add before number this https://api.whatsapp.com/send?phone=NumberHere',
            'default'  => ''
        ),
        array(
            'id'       => 'social_telegram',
            ...
            'subtitle' => "Your Telegram group/number",
            'desc'     => 'For click to open Telegram chat you will have to add your username after this https://t.me/ChangeWithYourUsername',
            'default'  => ''
        ),
		array(
			'id'       => 'social_dribbble',
...
$sections[] = array(
	...
	'fields'     => array(
        ...
        array(
			...
			'type'     => 'switch',
			'title'    => esc_html__( 'Sent email to the user with username and generated password', 'kleo' ),
			'subtitle' => esc_html__( 'Select if you want users who login with facebook to receive email with username and generated password.', 'kleo' ),
            'default'  => '1', // 1 = checked | 0 = unchecked
			'required' => array( 'facebook_register', '=', '1' ),
