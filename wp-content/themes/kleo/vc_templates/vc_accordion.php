...
$output = $title = $interval = $el_class = $collapsible = $active_tab = $icons_position = '';
//
...
$collapsible = $collapsible == 'yes' ? "" : ' id="accordion-' . esc_attr( $kleo_acc_id ) . '"';

$css_class = 'panel-group panel-kleo ' . trim( $el_class );

$css_class .= ' icons-' . $icons_position;

$output .= "\n\t" . '<div class="' . esc_attr( $css_class ) . '"' . $collapsible . ' data-active-tab="' . esc_attr( $active_tab ) . '">';
