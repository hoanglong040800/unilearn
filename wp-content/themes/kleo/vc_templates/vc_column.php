...
/* KLEO ADDED */
if ( $z_index != '' ) {
	$wrapper_attributes[] = 'style="z-index: ' . esc_attr( $z_index ) . ';"';
}
...
$output .= '<div class="vc_column-inner ' . esc_attr( trim( vc_shortcode_custom_css_class( $css ) ) ) . esc_attr( $extra_inner_class ) . '">';
